  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Signova Group — Premium Crop Nutrition" },
      {
        ...
        content: "Advanced micronutrients trusted by 100,000+ Indian farmers.",
      },
...
function HomePage() {
  ...
  const categories = [
    {
      icon: Atom,
      title: t("home.categories.chelated.title"),
      desc: t("home.categories.chelated.desc"),
      grad: "from-leaf to-deep",
    },
    {
      icon: Shield,
      title: t("home.categories.protectors.title"),
      desc: t("home.categories.protectors.desc"),
      grad: "from-deep to-charcoal",
    },
    {
      icon: Sparkles,
      title: t("home.categories.nano.title"),
      desc: t("home.categories.nano.desc"),
      grad: "from-lime to-leaf",
    },
    {
      icon: Droplets,
      title: t("home.categories.bio.title"),
      desc: t("home.categories.bio.desc"),
      grad: "from-leaf to-lime",
    },
    {
      icon: Leaf,
      title: t("home.categories.organic.title"),
      desc: t("home.categories.organic.desc"),
      grad: "from-deep to-leaf",
    },
    {
      icon: FlaskConical,
      title: t("home.categories.specialty.title"),
      desc: t("home.categories.specialty.desc"),
  ...
  const stories = [
    {
      name: "Ramesh Patel",
      crop: t("home.testimonials.cottonGuj"),
      quote: t("home.testimonials.rameshQuote"),
      img: farmer,
    },
    {
      name: "Lakshmi Devi",
      crop: t("home.testimonials.chilliAp"),
      quote: t("home.testimonials.lakshmiQuote"),
      img: farmer,
    },
    {
      name: "Suresh Kumar",
      crop: t("home.testimonials.paddyTel"),
      quote: t("home.testimonials.sureshQuote"),
      img: farmer,
    },
  ];
    ...
    slides: [
      {
        ...
        subtitle:
          "Advanced micronutrients and crop solutions trusted by thousands of farmers across India.",
  ...
  useEffect(() => {
    async function fetchHeroSettings() {
      try {
        const { data, error } = await withTimeout(
          supabase.from("frontend_settings").select("*").eq("key", "hero").single(),
        );
  ...
  const slideTitle =
    isDefault || activeSlide.title === "Redefining {Crop Nutrition} with Science & Innovation"
      ? t("home.hero.title")
      : activeSlide.title;
  ...
  const slideEyebrow =
    isDefault ||
    activeSlide.eyebrow === "Science • Nutrition • Growth" ||
    activeSlide.eyebrow === "Science \u2022 Nutrition \u2022 Growth"
      ? t("home.hero.eyebrow")
      : activeSlide.eyebrow;

  const primaryBtn =
    isDefault || activeSlide.primaryBtnText === "Explore Products"
      ? t("home.hero.explore")
      : activeSlide.primaryBtnText;

  const secondaryBtn =
    isDefault ||
    activeSlide.secondaryBtnText === "Become a Distributor" ||
    activeSlide.secondaryBtnText === "Become a Partner"
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-charcoal pt-28 pb-36">
          ...
          {heroSettings.layout === "split" && (
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
              ...
              >
                ...
                <p className="text-lg text-white/70 leading-relaxed max-w-xl">{slideSubtitle}</p>
              ...
              >
                ...
                {heroSettings.showSlideNumber !== false && (
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-dark text-xs uppercase tracking-[0.25em] text-lime mb-8">
                    ...
                    {slideEyebrow || `Slide ${currentSlide + 1} of ${heroSettings.slides.length}`}
                  </div>
                )}
        ...
        {heroSettings.layout === "slider" &&
          ...
          heroSettings.showControls !== false && (
            <div
              className={`absolute bottom-32 left-1/2 -translate-x-1/2 z-30 items-center gap-5 glass-dark px-4 py-2 rounded-full border border-white/10 shadow-glow-lime/5 flex ${
            ...
            >
              ...
              <button
                onClick={() =>
                  setCurrentSlide(
                    (prev) => (prev - 1 + heroSettings.slides.length) % heroSettings.slides.length,
                  )
                }
      ...
      <section className="py-28">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">{t("home.about.desc2")}</p>
            <Link
              to="/about"
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-bold">
              {renderTitle(t("home.categories.title"))}
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((c, i) => (
              ...
              >
                ...
                <Link
                  to="/products"
                  className="relative inline-flex items-center gap-1 text-sm font-semibold text-primary group-hover:gap-2 transition-all cursor-pointer"
                >
      ...
      <section className="relative py-32 bg-charcoal text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link
              to="/innovation"
              className="inline-flex items-center gap-2 mt-10 px-6 py-3 rounded-2xl bg-lime-gradient text-charcoal font-semibold cursor-pointer"
            >
      ...
      <section className="py-28">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-bold">
              {renderTitle(t("home.testimonials.title"))}
            </h2>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto relative overflow-hidden rounded-[2.5rem] bg-hero p-10 md:p-16 text-white">
          ...
          <div className="relative grid md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="text-xs uppercase tracking-[0.25em] text-lime font-semibold mb-4">
                {t("home.distributorCta.eyebrow")}
              </div>
              <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-5">
                {renderTitle(t("home.distributorCta.title"))}
              </h2>
              <p className="text-white/75 mb-8 max-w-md">{t("home.distributorCta.desc")}</p>
            ...
            <div className="glass-dark rounded-3xl p-8">
              ...
              <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                <input
                  ...
                  placeholder={t("home.distributorCta.namePlaceholder")}
                />
                <input
                  className="w-full bg-white/10 rounded-xl px-4 py-3 text-sm border border-white/15 placeholder:text-white/50 focus:outline-none focus:border-lime"
                  placeholder={t("home.distributorCta.phonePlaceholder")}
                />
                <input
                  className="w-full bg-white/10 rounded-xl px-4 py-3 text-sm border border-white/15 placeholder:text-white/50 focus:outline-none focus:border-lime"
                  placeholder={t("home.distributorCta.locationPlaceholder")}
                />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-6">
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-bold">
                {renderTitle(t("home.knowledge.title"))}
              </h2>
            </div>
            <Link
              to="/knowledge"
            ...
            {localizedArticles.map((a, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-lg font-bold leading-snug group-hover:text-primary transition leading-relaxed">
                    {a.title}
                  </h3>
                </div>
              </Link>

  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contact Signova Group" },
      {
        ...
        content: "Talk to an agronomist or partnership manager today.",
      },
    ],
  }),
  component: Contact,
...
function Contact() {
  ...
  const [contact, setContact] = useState({
    ...
    mapsEmbed:
      "https://www.openstreetmap.org/export/embed.html?bbox=78.40%2C17.50%2C78.55%2C17.55&layer=mapnik",
  });
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-3 gap-6 mb-16">
          {[
            ...
            { i: Mail, t: t("contact.info.email"), v: contact.email, s: "Response within 24 hrs" },
            {
              ...
              v: "Signova HQ",
              s:
                contact.address === "Plot 42, Genome Valley, Hyderabad, Telangana"
                  ? t("footer.addressVal")
                  : contact.address,
            },
          ].map((c, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <input
                className="bg-secondary rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-leaf"
            ...
            <input
              className="w-full bg-secondary rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-leaf"
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-5 py-3.5 rounded-xl bg-lime-gradient text-charcoal font-semibold cursor-pointer"
            >

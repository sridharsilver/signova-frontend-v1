...
function getLocalAgroResponse(prompt: string, lang: LanguageKey): string {
  ...
  const fallbacks: Record<LanguageKey, string> = {
    ...
    `,
    gu: `
      <h3 class="text-sm font-bold text-amber-500 flex items-center gap-1.5"><span class="size-2 rounded-full bg-amber-500"></span> પાક કાળજી સલાહકાર</h3>
      <p>પૂછવા માટે ધન્યવાદ! હું તમારા પાકનું સ્વાસ્થ્ય સુધારવામાં મદદ કરવા ઈચ્છું છું. સામાન્ય કૃષિ સલાહ માટે ઉપર જમણી બાજુના <strong>સેટિંગ્સ આઇકોન</strong> પર ક્લિક કરીને તમારી જેમિની API કી દાખલ કરો અને અદ્યતન જેમિની ચેટ નો લાભ લો!</p>
    `,
    mr: `
      <h3 class="text-sm font-bold text-amber-500 flex items-center gap-1.5"><span class="size-2 rounded-full bg-amber-500"></span> पीक काळजी सल्लागार</h3>
      <p>अधिक माहितीसाठी आणि अटींशिवाय प्रश्न विचारण्यासाठी, वर उजवीकडील <strong>सेटिंग्ज गियर</strong> वर क्लिक करा आणि तुमची जेमिनी API की प्रविष्ट करून थेट एआय चॅट सुरू करा!</p>
    `,
    ta: `
      ...
      <p>விவசாய ஆலோசனை பெற மேலே வலதுபுறத்தில் உள்ள <strong>அமைப்புகள் ஐகானை</strong> கிளிக் செய்து உங்கள் ஜெமினி API கீயை உள்ளிட்டு அன்லிமிடெட் AI அரட்டையை தொடங்குங்கள்!</p>
    `,
    kn: `
      ...
      <p>ನಿಮ್ಮ ಗೂಗಲ್ ಜೆಮಿನಿ API ಕೀಲಿಯನ್ನು ಸೆಟ್ಟಿಂಗ್ಸ್‌ನಲ್ಲಿ ನಮೂದಿಸಿ ಮತ್ತು ಸಂಪೂರ್ಣ ಬುದ್ಧಿವಂತ ಕೃಷಿ ಸಲಹೆಗಳನ್ನು ಪಡೆಯಿರಿ!</p>
    `
  };
